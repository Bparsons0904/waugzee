...
type UserStylus struct {
	BaseUUIDModel
	UserID       uuid.UUID        `gorm:"type:uuid;not null;index:idx_user_styluses_user"   json:"userId"`
	StylusID     uuid.UUID        `gorm:"type:uuid;not null;index:idx_user_styluses_stylus" json:"stylusId"`
	...
	IsPrimary    bool             `gorm:"type:bool;default:false;not null"                  json:"isPrimary"`
