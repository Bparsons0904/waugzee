...
func (c *AdminController) GetDownloadStatus(ctx context.Context) (*DownloadStatusResponse, error) {
	log := logger.NewWithContext(ctx, "adminController").Function("GetDownloadStatus")
...
func (c *AdminController) TriggerDownload(ctx context.Context) error {
	log := logger.NewWithContext(ctx, "adminController").Function("TriggerDownload")
...
func (c *AdminController) TriggerReprocess(ctx context.Context) error {
	log := logger.NewWithContext(ctx, "adminController").Function("TriggerReprocess")
...
func (c *AdminController) ResetStuckDownload(ctx context.Context) error {
	log := logger.NewWithContext(ctx, "adminController").Function("ResetStuckDownload")
...
func (c *AdminController) ListStoredFiles(ctx context.Context) (*StoredFilesResponse, error) {
	log := logger.NewWithContext(ctx, "adminController").Function("ListStoredFiles")
...
func (c *AdminController) CleanupAllFiles(ctx context.Context) error {
	log := logger.NewWithContext(ctx, "adminController").Function("CleanupAllFiles")
...
func (c *AdminController) CleanupYearMonth(ctx context.Context, yearMonth string) error {
	log := logger.NewWithContext(ctx, "adminController").Function("CleanupYearMonth")
...
func (c *AdminController) ImportKleioData(
	...
	log := logger.NewWithContext(ctx, "adminController").Function("ImportKleioData")
